...
저는 다양한 경험을 통해 성장하는 개발자입니다. AIoT, 음성 인식 애플리케이션, 자율주행 프로젝트에서 실시간 데이터 처리와 모델 개발 능력을 쌓았고, FastAPI, Docker, MySQL을 활용한 API 구현 및 배포 경험을 보유하고 있습니다. 새로운 기술을 빠르게 습득하고 프로젝트에 적용할 수 있는 역량을 키웠습니다.

또한, 협업 프로젝트에서는 Git을 활용한 형상 관리와 Slack, Notion을 통한 소통으로 팀의 진행 상황을 명확히 공유하고 조율했습니다. 문제 발생 시 팀원들과 적극적으로 소통하며 해결 방안을 도출하여 원활한 협업을 이끌었습니다.

저는 데이터를 단순한 정보가 아닌 가치를 창출하는 자원으로 인식하고, 이를 통해 사용자 경험을 혁신하며 서비스 가치를 높이는 데 집중해왔습니다. 예를 들어, 음성 인식 앱의 사용자 맞춤형 시스템 설계, AIoT 프로젝트의 약 20% 에너지 절감 성과를 이루어내며 사용자 편의성과 성능 개선에 기여했습니다.
